...
from langchain_core.messages import HumanMessage, AIMessage, MessageLikeRepresentation
...
from open_deep_research.deep_researcher_v2.state import Summary
from open_deep_research.deep_researcher_v2.configuration import SearchAPI, WorkflowConfiguration
from open_deep_research.deep_researcher_v2.prompts import summarize_webpage_prompt
...
@traceable
async def tavily_search_async(search_queries, max_results: int = 3, topic: Literal["general", "news", "finance"] = "general", include_raw_content: bool = True, config: RunnableConfig = None):
...
class ResearchComplete(BaseModel):
    """The research is complete and you are signaling that you are done researching. Only call this tool AFTER you haveconducted some research already with a websearch tool."""
